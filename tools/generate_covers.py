...
PROJECTS = [
    ...
    ("html-programing", "HTML Programing", "30 VANILLA-JS CHALLENGES",
     ("#0c0604", "#2e1a0a", "#ff2ea6", "#ffb300"), "brackets"),
    ("qwen", "Qwen Local LLM", "LOCAL-FIRST AI",
     ("#060410", "#141033", "#7b2fff", "#00e5ff"), "brain"),
